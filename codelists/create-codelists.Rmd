...
write_lines(sql_wild_ingredients, here("sql/rheumatology_meds_lookup.sql"))
```
...
- The SQL query is also saved in a separate file at `sql/rheumatology_meds_lookup.sql`
