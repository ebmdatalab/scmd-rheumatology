...
```{r, fig.width=10, fig.height=16, cache=TRUE, fig.cap="Figure. National prescribing of rheumatology treatments over time."}
temp_ggplot <- df_scmd_ddd %>%
  ...
  labs(x = NULL, y = "Defined Daily Dose (NOTE THAT UNITS ARE NOT ACCURATE)",
       colour = NULL) +
  geom_vline(xintercept = as.numeric(as.Date("2020-03-31")), 
             ...
             lwd = .5, 
             alpha = .5) +
  facet_wrap(~vtmnm, scales = "free_y", ncol = 2) +
...
```{r, fig.width=10, fig.height=16, fig.cap="Figure. Regional prescribing of rheumatology treatments over time."}
temp_ggplot <- df_scmd_ddd_map %>%
  ...
  labs(x = NULL, 
       y = "Defined Daily Dose (NOTE THAT UNITS ARE NOT ACCURATE)",
       colour = NULL) +
  facet_wrap(~vtmnm, ncol = 2, scales = "free_y") +
...
```{r fig.width=8, fig.height=4, fig.cap="Figure. Total regional prescribing of rheumatology treatments.", eval=FALSE}
temp_ggplot <- df_scmd_ddd_map %>% 
...
```{r, fig.width=8, fig.height=6, fig.cap="Figure. Total prescribing of rheumatology treatments for 20 STPs with the largest volume across all selected medications.", eval=FALSE}
